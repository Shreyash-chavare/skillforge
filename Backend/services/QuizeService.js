...
export const getOrFindQuiz = async (userId,topic,order) => {
  try {
    ...
    **Output Format**:
    Return ONLY a valid JSON object with a "questions" array and NO additional text, explanations, or markdown. Each question object must have:
    ...
    **Critical**: 
    ...
    // 5️⃣ Save inside topic.titles[order-1].quiz
    // Use atomic positional update to avoid VersionError
